        ...
        1: [function(b, c, d) {
            !function(b, e) {
                        ...
                        var i = c(1)
                          ...
                          , q = function(a, b) {
                            var c = a._attachment
                              ...
                              , n = h - (l - m);
                            m >= l ? (i(j, c, n),
                            a.stop(!0)) : (a._applyFilter("beforeTween"),
                            m < k + e ? (m = 1,
                            h = 1,
                            k = 1) : k += e,
                            p(m, d, g, j, h, k, f),
                          ...
                          , u = function() {
                            ...
                            (c = [{
                                ...
                                value: function() {
                                    if (this._isPlaying)
                                        return this._pausedAtTime = a.now(),
                                        this._isPlaying = !1,
                                        t(this),
                                        this
                                }
                                ...
                                value: function() {
                                    ...
                                    var b = a.now();
                                    return this._pausedAtTime && (this._timestamp += b - this._pausedAtTime,
                                    this._pausedAtTime = null),
                                    this._isPlaying = !0,
                                    null === m ? (m = this,
                                    n = this,
                                ...
                                value: function(b) {
                                    b = Math.max(b, 0);
                                    var c = a.now();
                                    return this._timestamp + b === 0 ? this : (this._timestamp = c - b,
                                ...
                                value: function() {
                                    ...
                                    if (this._isPlaying)
                                        ...
                                        t(this),
                                        a ? (this._applyFilter("beforeTween"),
                                        p(1, c, e, f, 1, 0, d),
                                        this._applyFilter("afterTween"),
                                        this._applyFilter("afterTweenEnd"),
                                        this._resolve(c, b)) : this._reject(c, b),
                                        this
                                }
                            }, {
                                key: "isPlaying",
                ...
                , function(a, b, c) {
                    ...
                    o = /,\s*/.source,
                    new RegExp("rgb\\(".concat(n).concat(o).concat(n).concat(o).concat(n, "\\)"),"g")), u = /^.*\(/, v = /#([0-9]|[a-f]){3,6}/gi, w = function(a, b) {
                        return a.map(function(a, c) {
                            return "_".concat(b, "_").concat(c)
                        })
                    }, x = function(a) {
                        return "rgb(".concat((b = a,
                        ...
                        for (var e in a) {
                            ...
                            "string" == typeof f && (d[e] = {
                                ...
                                c = void 0,
                                c = b.match(r),
                                c ? (1 === c.length || b.charAt(0).match(q)) && c.unshift("") : c = ["", ""],
                                c.join("VAL")),
                                chunkNames: w(B(f), e)
                            })
                        }
